...
const footerMenu: MenuItem[] = [
  {
    title: "Quick Links",
    links: [
      { text: "Job Packages", url: "/packages" },
      { text: "Post New Job", url: "/employer/post-job" },
      { text: "Jobs Listing", url: "/jobs" },
      { text: "Jobs Style Grid", url: "/jobs-grid" },
      { text: "Employer Listing", url: "/employer/listing" },
      { text: "Employers Grid", url: "/employer/grid" },
    ],
  },
  {
    title: "For Candidates",
    links: [
      { text: "User Dashboard", url: "/dashboard" },
      { text: "CV Packages", url: "/packages" },
      { text: "Candidate Listing", url: "/candidates" },
      { text: "Candidates Grid", url: "/candidates-grid" },
  ...
  },
  {
    ...
    links: [
      ...
      { text: "Employer Listing", url: "/employer/listing" },
      { text: "Employers Grid", url: "/employer/grid" },
      { text: "Job Packages", url: "/employer/packages" },
      { text: "Jobs Listing", url: "/employer/jobs" },
      { text: "Jobs Style Grid", url: "/employer/jobs-grid" },
    ],
  },
];
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 leading-relaxed max-w-sm">
              Job Searching Just Got Easy. Use JobZilla to run a hiring site and
